let array = [
  ...
  },
  {
    ...
    skills: ['Java', 'Heroku'],
    demoLink: 'https://lichess.org/@/ESC_BOT',
    codeLink: 'https://github.com/eansengchang/Better-Java-Chess-Engine',
    image: require('../../images/chess_program.png'),
  },
  {
    title: 'Online Square Brawl',
    description:
    ...
    skills: ['Node', 'Socket.io', 'Heroku', 'HTML'],
    demoLink: 'https://squarebrawl.netlify.app/',
